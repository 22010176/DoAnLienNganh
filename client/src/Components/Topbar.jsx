      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '30px' }}>
          <Button
            ...
            style={{
              color: 'white',
              background: activeTab === 'LỚP HỌC' ? 'rgba(255,255,255,0.2)' : 'transparent',
              border: 'none'
            }}
          >
            LỚP HỌC
          ...
          <Button
            ...
            style={{
              color: 'white',
              background: activeTab === 'MÔN HỌC' ? 'rgba(255,255,255,0.2)' : 'transparent'
            }}
          >
            MÔN HỌC
          </Button>
          <Button
            ...
            style={{
              color: 'white',
              background: activeTab === 'THI ONLINE' ? 'rgba(255,255,255,0.2)' : 'transparent'
            }}
          >
            THI ONLINE
          </Button>
